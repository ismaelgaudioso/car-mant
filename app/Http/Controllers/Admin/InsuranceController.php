...
class InsuranceController extends Controller
{
    ...
    {
        $cars = Car::all();
        return view('admin.insurance.create',compact('cars'));
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        return to_route('admin/insurance.index')->with('status','Insurance added');
    }
    ...
    public function show(Insurance $insurance)
    {
        ...
        return view("admin.insurance.show",compact('documents','insurance','car'));
    }
    ...
    public function edit(Insurance $insurance)
    {
        ...
        $car = Car::find($insurance->car_id);
        $cars = Car::all();
        return view("admin.insurance.edit",compact('documents','insurance','car','cars'));
    }
    ...
    public function update(PutRequest $request, Insurance $insurance)
    {
        ...
        return to_route("admin/insurance.show",compact('insurance'))->with('status','Insurance updated.');
    }
    ...
    {
        $insurance->delete();
        return to_route("admin/insurance.index")->with('status','Insurance deleted.');
    }
}
