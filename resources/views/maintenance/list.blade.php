                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="py-4 px-6"> {{ $maintenance->car->name }} </td>
                                    <td class="py-4 px-6"> {{ substr($maintenance->details,0,15) }} </td>
                                    ...
                                    <td class="py-4 px-6">
                                        <a href=" {{ route('maintenance.show',$car) }} "> <i class="fas fa-light fa-eye text-green-500"></i> </a>
                                        <a href=" {{ route('maintenance.edit',$car) }} "> <i class=" fas fa-light fa-pen-to-square text-blue-500"></i> </a>
                                        <a href=" {{ route('maintenance.destroy',$car) }} "> <i class="fas fa-light fa-trash text-red-500"></i> </a>
                                    </td>
