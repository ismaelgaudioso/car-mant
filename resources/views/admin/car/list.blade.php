<x-webapp-layout>
    ...
    <x-panel span="3">      
        ...
        <div class="flex justify-end m-2">
            <a href="{{ route('car.create')}}" class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600"><i class="fa-solid fa-plus"></i> Add a car</a>
        </div>
